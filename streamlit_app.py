...
def uji_molisch(nama_sampel):
    ...
    hasil_molisch = "Terbentuk :violet[Cincin Ungu] :green[(Uji Positif +)]" if nama_sampel.lower() in ["01", "02"] else "Tidak terbentuk :violet-background[Cincin Ungu] :red-background[(Uji Negatif -)]"
