...
def uji_molisch(nama_sampel):
    ...
    hasil_molisch = "Terbentuk :violet[Cincin Ungu] :green[(Uji Positif +)]" if nama_sampel.lower() in ["Fruktosa", "Pati"] else "Tidak terbentuk :violet[Cincin Ungu] :red[(Uji Negatif -)]"
